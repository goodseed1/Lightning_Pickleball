# 📰 Lightning Pickleball 피드 시스템 설계

## 🎯 개요

Lightning Pickleball의 **피드(Feed) 시스템**은 사용자들의 피클볼 활동을 중심으로 한 소셜 네트워크 기능입니다. 사용자가 경기를 완료하거나 새로운 친구를 추가할 때마다, 이러한 활동들이 자동으로 피드에 기록되어 커뮤니티 내에서 공유됩니다.
...
이 설계를 바탕으로 Lightning Pickleball의 피드 시스템은 사용자들의 피클볼 활동을 중심으로 한 활발한 소셜 커뮤니티를 구축할 수 있습니다. 각 사용자의 성취와 활동이 자연스럽게 공유되어, 동기부여와 커뮤니티 참여를 높이는 효과를 기대할 수 있습니다.
