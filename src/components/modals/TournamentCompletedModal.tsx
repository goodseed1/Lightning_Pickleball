...
interface TournamentCompletedModalProps {
  ...
  eventType: string; // 'mens_singles', 'womens_singles', 'mens_doubles', etc.
  onViewFeed?: () => void;
}


export const TournamentCompletedModal: React.FC<TournamentCompletedModalProps> = ({
  visible,
  onClose,
  winner,
  runnerUp,
        ...
        <View style={[styles.modalContainer, { backgroundColor: theme.colors.surface }]}>
          ...
          <View style={styles.header}>
            ...
            <Text style={[styles.title, { color: theme.colors.onSurface }]}>
              {t('modals.tournamentCompleted.title')}
            </Text>
            <Text style={[styles.subtitle, { color: theme.colors.onSurfaceVariant }]}>
              {tournamentName}
            </Text>
            <Text style={[styles.eventType, { color: theme.colors.primary }]}>
              {t(`types.tournament.eventTypes.${eventType}` as const)}
            </Text>
          </View>
          ...
          <View style={styles.winnerSection}>
            <View style={styles.winnerHeader}>
              ...
              <Text style={styles.winnerLabel}>{t('modals.tournamentCompleted.winner')}</Text>
            </View>
          ...
          {runnerUp && (
            <View style={styles.runnerUpSection}>
              <View style={styles.runnerUpHeader}>
                ...
                <Text style={styles.runnerUpLabel}>{t('modals.tournamentCompleted.runnerUp')}</Text>
              </View>
          ...
          <View style={styles.buttonContainer}>
            {onViewFeed && (
              ...
              >
                <Text style={[styles.buttonText, { color: theme.colors.onPrimary }]}>
                  {t('modals.tournamentCompleted.viewFeed')}
                </Text>
              </TouchableOpacity>
            )}
            <TouchableOpacity
            ...
            >
              <Text style={[styles.buttonText, { color: theme.colors.onSurface }]}>
                {t('modals.tournamentCompleted.close')}
              </Text>
            </TouchableOpacity>
          </View>
        </View>
