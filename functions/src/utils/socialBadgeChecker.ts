...
export const SOCIAL_BADGES = {
  ...
  SOCIAL_BUTTERFLY_BRONZE: {
    ...
    nameKo: '사교적인 나비 (5명)',
    description: 'Make 5 friends in the pickleball community',
    descriptionKo: '피클볼 커뮤니티에서 5명의 친구를 만드세요',
    icon: '🦋',
  ...
  SOCIAL_BUTTERFLY_SILVER: {
    ...
    nameKo: '사교적인 나비 (15명)',
    description: 'Make 15 friends in the pickleball community',
    descriptionKo: '피클볼 커뮤니티에서 15명의 친구를 만드세요',
    icon: '🦋',
  ...
  SOCIAL_BUTTERFLY_GOLD: {
    ...
    nameKo: '사교적인 나비 (50명)',
    description: 'Make 50 friends in the pickleball community',
    descriptionKo: '피클볼 커뮤니티에서 50명의 친구를 만드세요',
    icon: '🦋',
    tier: 'gold' as const,
    category: 'social',
