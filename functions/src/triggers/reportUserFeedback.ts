...
async function sendAdminNotification(
  ...
  try {
      ...
      <body>
        <div class="container">
          <div class="header ${data.detectedIssue.priority}">
            <h2>${priorityEmoji[data.detectedIssue.priority]} Lightning Tennis - User Issue Alert</h2>
          </div>
          ...
          <div class="footer">
            ...
            <p><a href="https://console.firebase.google.com/project/lightning-tennis-community/firestore/databases/-default-/data/~2Fuser_feedback~2F${feedbackId}">View in Firestore Console</a></p>
          </div>
        </div>
      </body>
      </html>
    ...
    const info = await transporter.sendMail({
      from: `"Lightning Tennis Sentinel" <${process.env.GMAIL_USER || 'noreply@lightningtennis.app'}>`,
      to: ADMIN_EMAIL,
      subject: subject,
      html: htmlBody,
    });
