# 번개 피클볼 앱 생태계 헌장 (v1.0 - 초안, Deprecated)

## 서문

우리는 시간과 장소, 소속의 제약 없이 모든 피클볼인이 자유롭게 만나고, 경쟁하며, 성장할 수 있는 디지털 생태계를 구축하는 것을 목표로 한다. '번개 피클볼'는 단순한 매칭 앱이 아니다. 이것은 당신의 모든 피클볼 여정이 기록되고, 성과가 존중받으며, 전 세계의 동료들과 영원히 공존하는 **살아있는 디지털 피클볼 세상**이다. 본 헌장은 이 자생(自生)하는 생태계의 번영을 위한 핵심 원칙과 규칙을 규정한다.
...
모든 경기는 사용자에 의해, 사용자를 위해 자율적으로 생성되고 운영된다. 번개 피클볼는 중앙에서 통제하는 리그가 아닌, 사용자가 만들어가는 풀뿌리 커뮤니티를 지향한다.

### 제2조 (접근성)

실력 향상의 기회는 모두에게 평등해야 한다. 번개 피클볼는 가입비나 참가비를 받지 않으며, 앱 내에서 누구나 쉽게 상대를 찾고 경기를 주선할 수 있는 가장 편리한 도구를 제공한다.
...
모든 참가비는 무료이다. 코트 예약 및 피클볼 공 준비는 경기 참여자들이 상호 협의하여 해결한다.
...
이 헌장은 '번개 피클볼'가 단순한 앱을 넘어, 모두가 함께 만들고 발전시켜나가는 **지속 가능한 디지털 피클볼 세계**로 나아가기 위한 초석이 될 것입니다.
...
## 🎯 번개 피클볼 앱 생태계 헌장 (v1.1 - 최종 공식 버전)

> **참고**: v1.0은 초안으로, v1.1이 현재 적용되는 공식 정책입니다.

#### **제2장: 랭킹 및 스킬 레벨 시스템 (수정)**

- **제1조 (두 개의 독립된 랭킹 시스템):** '번개 피클볼'에는 두 개의 완전히 독립된 랭킹 시스템이 존재한다.
