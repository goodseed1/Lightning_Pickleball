...
const translations = {
  ...
  'tournament.bracket.round': 'Раунд',
  'tournament.bracket.quarterfinals': 'Четвертьфиналы',
  'tournament.bracket.semifinals': 'Полуфиналы',
  'tournament.bracket.finals': 'Финалы',
  'tournament.bracket.winner': 'Победитель',
  'tournament.bracket.generateBracket': 'Создать сетку',
  'tournament.bracket.seedPlayers': 'Распределить игроков',
  'tournament.bracket.randomize': 'Случайный порядок',
