...
const seasonTrophyTranslations = {
  en: {
    ...
    seasonChampionDesc: 'Achieved 1st place in your LTR grade group',
    seasonRunnerUp: 'Season Runner-up',
    seasonRunnerUpDesc: 'Achieved 2nd place in your LTR grade group',
    season3rdPlace: 'Season 3rd Place',
    season3rdPlaceDesc: 'Achieved 3rd place in your LTR grade group',
    rankUp: 'Rank Up',
    rankUpDesc: 'Improved your LTR grade during the season',
    ironMan: 'Iron Man',
  ...
  ko: {
    ...
    seasonChampionDesc: 'LTR 등급 그룹 내 1위 달성',
    seasonRunnerUp: '시즌 준우승',
    seasonRunnerUpDesc: 'LTR 등급 그룹 내 2위 달성',
    season3rdPlace: '시즌 3위',
    season3rdPlaceDesc: 'LTR 등급 그룹 내 3위 달성',
    rankUp: '랭크업',
    rankUpDesc: '시즌 중 LTR 등급 상승',
    ironMan: '아이언맨',
  ...
  es: {
    ...
    seasonChampionDesc: 'Logró el 1er lugar en su grupo de grado LTR',
    seasonRunnerUp: 'Subcampeón de Temporada',
    seasonRunnerUpDesc: 'Logró el 2do lugar en su grupo de grado LTR',
    season3rdPlace: '3er Lugar de Temporada',
    season3rdPlaceDesc: 'Logró el 3er lugar en su grupo de grado LTR',
    rankUp: 'Subir de Rango',
    rankUpDesc: 'Mejoró su grado LTR durante la temporada',
  ...
  zh: {
    seasonChampion: '赛季冠军',
    seasonChampionDesc: '在您的LTR等级组中获得第1名',
    seasonRunnerUp: '赛季亚军',
    seasonRunnerUpDesc: '在您的LTR等级组中获得第2名',
    season3rdPlace: '赛季季军',
    season3rdPlaceDesc: '在您的LTR等级组中获得第3名',
    rankUp: '升级',
    rankUpDesc: '在赛季中提升了您的LTR等级',
    ironMan: '铁人',
  ...
  ja: {
    ...
    seasonChampionDesc: 'LTRグレードグループで1位を達成',
    seasonRunnerUp: 'シーズン準優勝',
    seasonRunnerUpDesc: 'LTRグレードグループで2位を達成',
    season3rdPlace: 'シーズン3位',
    season3rdPlaceDesc: 'LTRグレードグループで3位を達成',
    rankUp: 'ランクアップ',
    rankUpDesc: 'シーズン中にLTRグレードが向上',
    ironMan: 'アイアンマン',
  ...
  vi: {
    ...
    seasonChampionDesc: 'Đạt hạng 1 trong nhóm cấp LTR của bạn',
    seasonRunnerUp: 'Á quân mùa giải',
    seasonRunnerUpDesc: 'Đạt hạng 2 trong nhóm cấp LTR của bạn',
    season3rdPlace: 'Hạng 3 mùa giải',
    season3rdPlaceDesc: 'Đạt hạng 3 trong nhóm cấp LTR của bạn',
    rankUp: 'Thăng hạng',
    rankUpDesc: 'Cải thiện cấp LTR trong mùa giải',
    ironMan: 'Người sắt',
  ...
  fr: {
    ...
    seasonChampionDesc: 'A obtenu la 1ère place dans votre groupe de niveau LTR',
    seasonRunnerUp: 'Vice-champion de Saison',
    seasonRunnerUpDesc: 'A obtenu la 2ème place dans votre groupe de niveau LTR',
    season3rdPlace: '3ème Place de Saison',
    season3rdPlaceDesc: 'A obtenu la 3ème place dans votre groupe de niveau LTR',
    rankUp: 'Montée en Grade',
    rankUpDesc: 'A amélioré votre niveau LTR pendant la saison',
  ...
  de: {
    ...
    seasonChampionDesc: 'Platz 1 in Ihrer LTR-Gradgruppe erreicht',
    seasonRunnerUp: 'Saison-Zweiter',
    seasonRunnerUpDesc: 'Platz 2 in Ihrer LTR-Gradgruppe erreicht',
    season3rdPlace: 'Saison-Dritter',
    season3rdPlaceDesc: 'Platz 3 in Ihrer LTR-Gradgruppe erreicht',
    rankUp: 'Rangaufstieg',
    rankUpDesc: 'LTR-Grad während der Saison verbessert',
  ...
  it: {
    ...
    seasonChampionDesc: 'Ha raggiunto il 1° posto nel tuo gruppo di grado LTR',
    seasonRunnerUp: 'Vice Campione di Stagione',
    seasonRunnerUpDesc: 'Ha raggiunto il 2° posto nel tuo gruppo di grado LTR',
    season3rdPlace: '3° Posto di Stagione',
    season3rdPlaceDesc: 'Ha raggiunto il 3° posto nel tuo gruppo di grado LTR',
    rankUp: 'Promozione',
    rankUpDesc: 'Ha migliorato il tuo grado LTR durante la stagione',
  ...
  pt: {
    ...
    seasonChampionDesc: 'Alcançou o 1º lugar no seu grupo de nível LTR',
    seasonRunnerUp: 'Vice-campeão da Temporada',
    seasonRunnerUpDesc: 'Alcançou o 2º lugar no seu grupo de nível LTR',
    season3rdPlace: '3º Lugar da Temporada',
    season3rdPlaceDesc: 'Alcançou o 3º lugar no seu grupo de nível LTR',
    rankUp: 'Subir de Rank',
    rankUpDesc: 'Melhorou seu nível LTR durante a temporada',
