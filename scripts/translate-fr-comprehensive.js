...
const translations = {
  ...
  admin: {
    devTools: {
      loading: 'Chargement...',
      pickleballStats: '📊 Statistiques de pickleball',
      matchesPlayed: 'Matchs joués',
      wins: 'Victoires',
      winRate: 'Taux de victoire',
  ...
  clubOverviewScreen: {
    ...
    bpaddleGeneration: 'Génération de bpaddle',
  ...
  clubTournamentManagement: {
    management: {
      ...
      generateBracket: 'Générer le bpaddle',
  ...
  leagues: {
    admin: {
      ...
      bpaddleGeneratedTitle: '📊 Bracket généré',
      bpaddleGeneratedMessage: 'Le bpaddle du tournoi a été généré avec succès.',
      bpaddleGenerateError:
        "Une erreur s'est produite lors de la génération du bpaddle. Veuillez réessayer.",
