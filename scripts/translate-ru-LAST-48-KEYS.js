  ...
  utils: {
    ltr: {
      whatIsLtr: {
        title: 'Что такое LTR?',
        content:
          'LTR (Lightning Tennis Rating) — это проприетарная система оценки навыков, разработанная исключительно для сообщества Lightning Tennis. LTR рассчитывается на основе алгоритма ELO, применяемого ко всем результатам публичных молниеносных матчей, показывая ваш рост в интуитивной шкале от 1 до 10. Это почётный показатель того, насколько вы выросли в нашей экосистеме.',
      },
      relationToNtrp: {
        title: 'Связь с NTRP',
        content:
          'LTR — это уникальная система, отличная от NTRP USTA. Для удобства пользователей, знакомых с рейтингами NTRP, вы можете выбрать свой уровень навыков в диапазоне, похожем на NTRP, при регистрации, но все официальные уровни, рассчитанные и отображаемые в приложении, основаны на LTR.',
      },
    },
  },
