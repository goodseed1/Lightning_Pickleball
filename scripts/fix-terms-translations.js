...
const translations = {
  'ja.json': {
    terms: {
      ...
      noticeContent:
        'Lightning Pickleballはテニスプレイヤーを繋ぐプラットフォームです。実際の試合中に発生する安全事故や紛争の責任は参加者にあり、当社はこれらの事項について法的責任を負いません。',
  ...
  'de.json': {
    terms: {
      ...
      introSubtitle: 'Diese Bedingungen gewährleisten eine sichere und angenehme Pickleball-Community',
      stepProgress: 'Schritt {{current}} von {{total}}',
      agreeAll: 'Allen Bedingungen zustimmen',
      importantNotice: 'Wichtiger Hinweis',
      noticeContent:
        'Lightning Pickleball ist eine Plattform, die Pickleballspieler verbindet. Die Verantwortung für Sicherheitsvorfälle oder Streitigkeiten während tatsächlicher Spiele liegt bei den Teilnehmern, und wir übernehmen keine rechtliche Haftung für diese Angelegenheiten.',
  ...
  'fr.json': {
    terms: {
      ...
      introSubtitle: 'Ces conditions garantissent une communauté de pickleball sûre et agréable',
  ...
  'it.json': {
    terms: {
      ...
      introSubtitle: 'Questi termini garantiscono una comunità pickleballtica sicura e piacevole',
      stepProgress: 'Passaggio {{current}} di {{total}}',
      agreeAll: 'Accetta tutti i termini',
      importantNotice: 'Avviso importante',
      noticeContent:
        'Lightning Pickleball è una piattaforma che connette giocatori di pickleball. La responsabilità per incidenti di sicurezza o controversie durante le partite reali spetta ai partecipanti, e non assumiamo responsabilità legale per queste questioni.',
  ...
  'pt.json': {
    terms: {
      ...
      importantNotice: 'Aviso importante',
      noticeContent:
        'Lightning Pickleball é uma plataforma que conecta jogadores de tênis. A responsabilidade por incidentes de segurança ou disputas durante partidas reais é dos participantes, e não assumimos responsabilidade legal por esses assuntos.',
  ...
  'zh.json': {
    terms: {
      ...
      noticeContent:
        'Lightning Pickleball是一个连接网球运动员的平台。实际比赛期间发生的安全事故或纠纷的责任由参与者承担，我们不承担这些事项的法律责任。',
      ...
      details: {
        ...
        liabilityDisclaimer: {
          title: '免责声明',
          content:
            '⚠️ 重要法律通知 ⚠️\n\nLightning Pickleball应用作为连接个人网球运动员的平台。\n\n我们不承担以下法律责任：\n\n1. 安全事故免责\n- 网球比赛期间的伤害或事故\n- 比赛参与者之间的个人纠纷\n- 网球场设施的安全事故\n\n2. 财务纠纷免责\n- 与比赛费用相关的纠纷\n- 与场地租赁费相关的问题\n- 用户之间的财务交易\n\n3. 用户责任\n- 比赛的所有安全和责任由主办方和参与者承担\n- 用户必须在参加前确认自己的健康状况\n- 建议购买适当的保险\n\n使用本服务即表示您同意这些免责条款。',
        },
        marketingCommunications: {
          title: '营销通讯同意',
          content:
  ...
  'ru.json': {
    terms: {
      ...
      noticeContent:
        'Lightning Pickleball — это платформа, соединяющая теннисистов. Ответственность за инциденты безопасности или споры во время реальных матчей лежит на участниках, и мы не несем юридической ответственности за эти вопросы.',
