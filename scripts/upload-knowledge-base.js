  ...
  if (language === 'ko') {
    return [
      ...
      },
      {
        ...
        answer:
          'LTR(Lightning Tennis Rating)은 Lightning Tennis 앱의 고유한 ELO 기반 실력 평가 시스템입니다. 1(Bronze, 초보자)부터 10(Legend, 최상위)까지 10단계로 나뉩니다. ELO 점수(600-2400+)를 기반으로 자동 계산되며, 실제 경기 결과에 따라 변동됩니다.',
    ...
    return [
      {
        ...
        answer:
          'Lightning Match is a 1:1 ranked game where ELO scores change, and match results are reflected in rankings. Lightning Meetup is a friendly game with multiple participants that does not affect rankings, meant for enjoyable tennis exchange.',
      ...
      },
      {
        ...
        answer:
          'LTR (Lightning Tennis Rating) is the unique ELO-based skill evaluation system of Lightning Tennis app. It ranges from 1 (Bronze, beginner) to 10 (Legend, top-tier). It is automatically calculated based on ELO score (600-2400+) and changes according to actual match results.',
        keywords: [
          'LTR',
          'level',
          'skill',
      ...
      {
        question: 'What is the difference between LTR and NTRP?',
        answer:
          '📊 LTR vs NTRP Comparison:\n\n【LTR (Lightning Tennis Rating)】\n• Range: 1-10 (integer)\n• Based on: ELO algorithm (chess ranking style)\n• Updates: Automatic real-time after each match\n• Feature: Lightning Tennis app exclusive system\n• Evaluation: Objective based on match results\n\n【NTRP (National Tennis Rating Program)】\n• Range: 1.0-7.0 (decimal)\n• Based on: USTA official criteria\n• Updates: Self-assessment or certified coach evaluation\n• Feature: Official USTA system\n• Evaluation: Subjective based on skill checklist\n\n【LTR ↔ NTRP Conversion】\n• LTR 1-2 = NTRP 1.5-2.5 (Beginner)\n• LTR 3-4 = NTRP 3.0-3.5 (Intermediate entry)\n• LTR 5-6 = NTRP 4.0-4.5 (Intermediate)\n• LTR 7 = NTRP 5.0 (Upper Intermediate)\n• LTR 8-9 = NTRP 5.5-6.0 (Advanced)\n• LTR 10 = NTRP 6.5-7.0 (Top tier)',
        keywords: [
          'LTR',
          'NTRP',
          'difference',
      ...
      {
        question: 'How to convert LTR to NTRP?',
        answer:
          '🎾 LTR ↔ NTRP Conversion Table:\n\n• LTR 1-2 = NTRP 1.5-2.5 (Beginner)\n• LTR 3-4 = NTRP 3.0-3.5 (Intermediate entry)\n• LTR 5-6 = NTRP 4.0-4.5 (Intermediate)\n• LTR 7 = NTRP 5.0 (Upper Intermediate)\n• LTR 8-9 = NTRP 5.5-6.0 (Advanced)\n• LTR 10 = NTRP 6.5-7.0 (Top tier)\n\nExample: LTR 5 is approximately NTRP 4.0!\n\nNote: This conversion is approximate. LTR is based on actual match results while NTRP is self-reported, so they may not match exactly.',
        keywords: [
          'LTR',
          'NTRP',
          'convert',
      ...
      {
        question: 'What is the official email address for Lightning Tennis?',
        answer:
          'The official email address for Lightning Tennis is lightningtennisapp@gmail.com. Please send all inquiries including questions, feedback, bug reports, and partnership inquiries to this email. We will respond as soon as possible! ⚡',
